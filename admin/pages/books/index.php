<?php include_once('../authen.php');
  ...
  $sql  = "SELECT B.*,T.type_name FROM books B JOIN book_type T
  ON B.type_id = T.code" ;
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-header"><center>
          <h3 class="card-title d-inline-block col-form-label">บันทึกข้อมูลหนังสือ</h3><br>
          <a href="form.php" class="btn btn-warning float-right"  style="color:white"><i class="fas fa-plus"> เพิ่มข้อมูล</i></a href="">
        </div>
        <div class="card-body">
          ...
          <table id="dataTable" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <th width="10%"><center>รหัสหนังสือ</th>
              <th width="20%"><center>ชื่อหนังสือ</th>
              <th width="20%"><center>ผู้แต่ง</th>
              <th width="5%"><center>ราคา</th>
              <th width="5%"><center>จำนวนหนังสือ</th>
              <th width="20%"><center>ประเภทหนังสือ</th>
            ...
            ?>
              <tr>
                ...
                <td><center><?php echo $row['quantity_book']; ?></td>
