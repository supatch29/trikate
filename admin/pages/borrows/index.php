...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="../../plugins/datatables/dataTables.bootstrap4.min.css"></head>
    <style>
    table, td, th {
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-header"><center>
          <h3 class="card-title d-inline-block col-form-label">บันทึกการยืมหนังสือ</h3><br>
          <a  href="form.php" class="btn btn-warning float-right"><i class="fas fa-plus"  style="color:white">เพิ่มการยืม</i></a href=""><br>
  </div>
